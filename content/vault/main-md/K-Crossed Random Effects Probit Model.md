...
tags: [crossed, research, stanford/y2]
modified: 2026-04-24T10:31:30-07:00
...
> $$\begin{align*} Y_{\ell} = \mathbf{1}\left[x_{\ell}^{\intercal}\beta + a_{\ell}^{\intercal}\mathbf{1} + \varepsilon_{\ell} > 0 \right] ,  \end{align*}$$
