...
$$\begin{aligned} Y_{ij} = X_{ij}^{\intercal}\beta + X_{A, j}^{\intercal}a_{i} + X_{B, i}^{\intercal} b_{j} + \varepsilon_{ij}, \end{aligned}$$
...
$$\begin{aligned} \beta_{i} := \left( \beta ^{\intercal} \, \,  a_{i}^{\intercal}\right)^{\intercal} \in \mathbb{R}^{p + p_{A}},  \end{aligned}$$
...
$$\begin{aligned} \hat{\beta}_{i} = \left( \tilde{X}^{\intercal}_{i} \tilde{X}_{i} \right)^{-1} \tilde{X}^{\intercal}_{i} Y_{i} \end{aligned}$$
...
$$\begin{aligned} \left( \tilde{X}_{i}^{\intercal}\tilde{X}_{i} \right)^{-1} &=: \begin{pmatrix} X'X & X'X_{A} \\ X_{A}'X &X_{A}'X_{A} \end{pmatrix}^{-1}, \end{aligned}$$
...
$$\begin{aligned} \begin{pmatrix} X'X & X'X_{A} \\ X_{A}'X &X_{A}'X_{A} \end{pmatrix}^{-1} &= \begin{pmatrix} (X'X - X'X_{A}(X_{A}'X_{A})^{-1}X_{A}'X)^{-1} & 0 \\ 0 & (X_{A}'X_{A} - X_{A}'X(X'X)^{-1}X'X_{A})^{-1} \end{pmatrix} \begin{pmatrix} I & -X'X_{A}(X_{A}'X_{A})^{-1} \\ -X_{A}'X(X'X)^{-1} & I \end{pmatrix}  \end{aligned}$$


for which we recover with the SVD
$$\begin{aligned} \hat{\beta_{i}} = [X_{i}'(I - P_{X_{A}})^{-1} X_{i}]^{-1} X_{i}'(I - P_{X_{A}})(X'\beta + X_{A, j}'a_{i} + X_{B, i}'b + \varepsilon_{i}). \end{aligned}$$
